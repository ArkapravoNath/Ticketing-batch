...
import com.gok.ticketingbatch.repository.DocumentRepository;
import com.gok.ticketingbatch.service.DocumentService;
import com.gok.ticketingbatch.service.dto.DocumentDTO;
import com.gok.ticketingbatch.service.mapper.DocumentMapper;
...
public class DocumentResourceIT {
    ...
    public void createDocument() throws Exception {
        ...
        assertThat(testDocument.getIdType()).isEqualTo(DEFAULT_ID_TYPE);
        assertThat(testDocument.getIdNumber()).isEqualTo(DEFAULT_ID_NUMBER);
    ...
    public void updateDocument() throws Exception {
        ...
        Document testDocument = documentList.get(documentList.size() - 1);
        assertThat(testDocument.getIdType()).isEqualTo(UPDATED_ID_TYPE);
        assertThat(testDocument.getIdNumber()).isEqualTo(UPDATED_ID_NUMBER);
