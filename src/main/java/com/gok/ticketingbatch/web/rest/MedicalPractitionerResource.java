...
import com.gok.ticketingbatch.service.MedicalPractitionerService;
...
/**
 * REST controller for managing {@link com.gok.ticketingbatch.domain.MedicalPractitioner}.
 */
@RestController
@RequestMapping("/api")
public class MedicalPractitionerResource {
    ...
    private static final String ENTITY_NAME = "ticketingBatchMedicalPractitioner";
