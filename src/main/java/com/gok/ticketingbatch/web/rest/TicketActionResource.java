...
import com.gok.ticketingbatch.service.TicketActionService;
...
/**
 * REST controller for managing {@link com.gok.ticketingbatch.domain.TicketAction}.
 */
@RestController
@RequestMapping("/api")
public class TicketActionResource {
    ...
    private static final String ENTITY_NAME = "ticketingBatchTicketAction";
